...
// Function to get database configuration from AWS Systems Manager Parameter Store
async function getDbConfig() {
  ...
  try {
    ...
    const parameterNames = [
      '/amplify/shared/d21ksqcg3akub4/MYSQL_HOST',
      '/amplify/shared/d21ksqcg3akub4/MYSQL_USER',
      '/amplify/shared/d21ksqcg3akub4/MYSQL_PASSWORD',
      '/amplify/shared/d21ksqcg3akub4/MYSQL_DATABASE',
      '/amplify/shared/d21ksqcg3akub4/MYSQL_PORT',
    ];

    console.log('Fetching database configuration from Parameter Store...');
    ...
    response.Parameters.forEach(param => {
      const key = param.Name.split('/').pop(); // Extract just the parameter name
      parameters[key] = param.Value;
    });

    dbConfig = {
      host: parameters.MYSQL_HOST,
      port: parseInt(parameters.MYSQL_PORT || '3306'),
      user: parameters.MYSQL_USER,
    ...
    console.log('Database config loaded from Parameter Store:', {
    ...
    console.error('Error fetching database configuration from Parameter Store:', error);
