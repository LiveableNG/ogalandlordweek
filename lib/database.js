...
export const CREATE_TABLE_SQL = `
  CREATE TABLE IF NOT EXISTS form_submissions (
    ...
    one_on_one_consultation BOOLEAN DEFAULT FALSE,
    live_question_and_answer_sessions BOOLEAN DEFAULT FALSE,
    physical_events BOOLEAN DEFAULT FALSE,
    healthy_wealthy_party BOOLEAN DEFAULT FALSE,
  ...
  try {
    ...
    const [result] = await pool.execute(
      `INSERT INTO form_submissions (
        ...
        additional_questions, wants_dashboard, wants_course, one_on_one_consultation, 
        live_question_and_answer_sessions, physical_events, healthy_wealthy_party, 
        whatsapp_consent, user_agent, ip_address
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        data.name,
        data.email,
        ...
        data.oneOnOneConsultation || false,
        data.liveQuestionAndAnswerSessions || false,
        data.physicalEvents || false,
        data.healthyWealthyParty || false,
