...
const dbConfig = {
  host: process.env.MYSQL_HOST || 'goodtenants-db.ctco8mqkw97l.us-east-1.rds.amazonaws.com',
  port: parseInt(process.env.MYSQL_PORT || '3306'),
  user: process.env.MYSQL_USER || 'admin',
  password: process.env.MYSQL_PASSWORD || 'hjSQPfuPOux3SnQowq5j',
  database: process.env.MYSQL_DATABASE || 'liveableindex_db',
  connectionLimit: 10,
};
