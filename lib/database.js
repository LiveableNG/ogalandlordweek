...
export function getDbPool() {
  if (!pool) {
    // Database connection configuration - moved inside function to ensure env vars are available
    const dbConfig = {
    ...
    if (!dbConfig.host || !dbConfig.user || !dbConfig.password || !dbConfig.database) {
      ...
      throw new Error(`Missing required database environment variables: ${missing.join(', ')}. Please check your Amplify environment variables.`);
    }
